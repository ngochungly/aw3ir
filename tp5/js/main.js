    ...
    app = new Vue({
        ...
        methods: {
            ...
            meteo: function (_city) {  
                ...
                API_key = '01b4546668f7db110627282fcea95e3e';

                // appel AJAX avec fetch
                fetch('https://api.openweathermap.org/data/2.5/weather?q='+_city.name+'&units=metric&lang=fr&apikey='+API_key)
                    ...
                    .then(function(json) {
                        ...
                        if (json.cod === 200) {
                            ...
                            app.position_img_url = 'https://maps.googleapis.com/maps/api/staticmap?markers='
                                +app.cityWeather.coord.lat+','
                                +app.cityWeather.coord.lon
